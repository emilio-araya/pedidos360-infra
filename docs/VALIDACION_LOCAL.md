...
|---|---|
| `ms-pedidos360-catalog` | 14 pruebas, 0 fallos; SpotBugs sin hallazgos no excluidos |
| `ms-pedidos360-orders` | 28 pruebas, 0 fallos; SpotBugs sin hallazgos no excluidos |
| `ms-pedidos360-bff` | 16 pruebas, 0 fallos; SpotBugs sin hallazgos |
| `frontend-pedidos360` | 18 pruebas, 0 fallos; TypeScript, Vite build y bundle Nginx correctos |
| Total automatizado | **76 pruebas, 0 fallos** |
...
| Callback MSAL | Procesamiento explícito del callback en `/login` y navegación posterior al dashboard; 18 pruebas frontend aprobadas |
